        ...
        <div class="p-5 sm:p-6">
            <form method="GET" action="{{ route('admin.reports.attendance') }}">
                ...
                <div class="mt-6 flex gap-2">
                    ...
                    <a href="{{ route('admin.reports.attendance') }}" class="inline-flex items-center rounded-[10px] border border-slate-200 bg-white text-ink font-semibold px-4 py-2.5 hover:bg-slate-50 transition">Reset</a>
                </div>
            </form>
        </div>
    </div>
